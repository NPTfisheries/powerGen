...
# this script will run each time you Run App or deploy.  Adjust the boolean as needed.
requery_data <- FALSE

if(requery_data == FALSE) {
  cat('Using existing data (powerGen_data.R) \n')
}

if(requery_data == TRUE) {
  cat('Re-querying power_data.rda (powerGen_data.R) \n')
  
  # fisheR preventing deploy to shinyapps 12/3/24.  I am commenting to get beyond that.
